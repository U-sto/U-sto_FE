      ...
      <DataTable<DisuseItemRow>
        ...
        renderActions={() => (
          <div className="disuse-table-actions">
            <Button className="disuse-btn disuse-btn-outline disuse-btn-table">
              반려
            </Button>
            <Button className="disuse-btn disuse-btn-primary disuse-btn-table">
              확정
            </Button>
          </div>
        )}
